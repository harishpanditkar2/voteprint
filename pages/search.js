...
export default function SearchPage() {
            ...
            <div class="${index < votersToGenerate.length - 1 ? 'page-break' : ''}">
              ...
              <div class="info-box">
                ...
                <div class="info-line">
                  ...
                  <span class="info-value">${voter.gender === 'M' ? 'पुरुष' : voter.gender === 'F' ? 'स्त्री' : 'N/A'}</span>
                </div>
                <div class="info-line">
  ...
  const printVoter = (voter, e) => {
    ...
    if (wardNumber === '16') {
      // Prabhag 16 booths
      if (boothNumber === '1') pollingCenter = 'नगरपरिषद स.नं.220, बालवाडी खोली, बारामती';
      else if (boothNumber === '2') pollingCenter = 'नगरपरिषद क्षेत्रीय टकारी, समाजमंदिर, पाश्चिमाभिमुख हॉल, तांदुळवाडी वेस, बारामती';
      else if (boothNumber === '3') pollingCenter = 'सर्वे नंबर 220 येथील होलार समाज मंदिर, बारामती';
      else if (boothNumber === '4') pollingCenter = 'होमगार्ड कार्यालय, सर्वे नंबर 220, बारामती';
      else if (boothNumber === '5') pollingCenter = 'नगरपरिषद बाबासाहेब देशमुख समाज मंदिर, दक्षिणाभिमुख खोली क्र.3, सर्वे नंबर 220, बारामती';
      else if (boothNumber === '6') pollingCenter = 'नगरपरिषद बाबासाहेब देशमुख समाज मंदिर, दक्षिणाभिमुख खोली क्र.4, सर्वे नंबर 220, बारामती';
      else if (boothNumber === '7') pollingCenter = 'नगरपरिषद शाळा क्र.6, दक्षिणेकडून पश्चिममुखी खोली क्र.३, शारदा प्रांगण, बारामती';
    } else {
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <div class="info-box">
          ...
          ${voter.gender ? `<div class="info-line">
            <span class="info-label">लिंग:</span>
            <span class="info-value">${voter.gender === 'M' ? 'पुरुष' : voter.gender === 'F' ? 'स्त्री' : '-'}</span>
          </div>` : ''}
