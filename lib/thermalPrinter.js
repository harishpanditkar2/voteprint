...
class ThermalPrinterManager {
  ...
  generateVoterCardCommands(voter) {
    ...
    commands.push(this.createTextCommand(`नाव: ${voter.name || 'N/A'}`));
    commands.push(this.createTextCommand(`मतदार क्रमांक: ${voter.voterId || 'N/A'}`));
    commands.push(this.createTextCommand(`वय: ${voter.age || 'N/A'} | लिंग: ${voter.gender === 'M' ? 'पुरुष' : voter.gender === 'F' ? 'स्त्री' : 'N/A'}`));
    commands.push(this.createTextCommand(`घर क्र: ${voter.houseNumber || 'N/A'}`));
    commands.push(this.createTextCommand(`प्रभाग: ${voter.actualWard || 'N/A'} | बूथ: ${voter.actualBooth || 'N/A'}`));
    commands.push(this.createDashedLine());
    commands.push(this.createTextCommand(`${voter.pollingCenter || 'N/A'}`));
