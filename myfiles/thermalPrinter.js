...
class ThermalPrinterManager {
  ...
  generateVoterCardCommands(voter) {
    ...
    commands.push(this.createTextCommand(`ID: ${voter.serialNumber || 'N/A'}`));
    commands.push(this.createTextCommand(`Age: ${voter.age || 'N/A'} | Gender: ${voter.gender || 'N/A'}`));
    commands.push(this.createTextCommand(`Address: ${voter.address || 'N/A'}`));
    commands.push(this.createTextCommand(`Booth: ${voter.booth || 'N/A'}`));
    commands.push(this.createTextCommand(`Ward: ${voter.ward || 'N/A'}`));
